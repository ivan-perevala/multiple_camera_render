...
from .. _framebuffer_framework import Mode, FrameBufferFramework
...
class SMAA(AABase):
    ...
    _fb_framework_stage_0: FrameBufferFramework
    "Буфер кадру для першої стадії обробки."
    _fb_framework_stage_1: FrameBufferFramework
    ...
    def __init__(
        ...
        *,
        ...
        self._shaders_eval = tuple()
        self._fb_framework_stage_0 = FrameBufferFramework(
            mode=mode,
            area_type=area_type,
            region_type=region_type
        )
        self._fb_framework_stage_1 = FrameBufferFramework(
            mode=mode,
            area_type=area_type,
            region_type=region_type
        )
